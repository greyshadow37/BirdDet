...
def run_rtdetr_evaluation(model_path, data_yaml_path=None, imgsz=512, conf_thresh=0.25, iou_thresh=0.5,
                          output_dir="test_rtdetr_results", images_dir=None, labels_dir=None, ann_path=None,
                          excel_filename="rtdetr_test_evaluation.xlsx"):
    """
    Run custom image-by-image evaluation for RT-DETR model and export comprehensive metrics to Excel.
    Does NOT use model.val() and does NOT save bounding box overlay images.
    """
    os.makedirs(output_dir, exist_ok=True)
    
    print(f"\n=======================================================")
    print(f"          RT-DETR Model Evaluation (Per-Image)         ")
    print(f"=======================================================")
    ...
    # Load RT-DETR Model
    print(f"Loading RT-DETR model weights from: {model_path}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate RT-DETR model per-image and output metrics to Excel.")
    ...
    parser.add_argument('--output-dir', type=str, default="test_rtdetr_results", help='Directory for output results')
    ...
    parser.add_argument('--excel-filename', type=str, default="rtdetr_test_evaluation.xlsx", help='Name of output Excel file')
